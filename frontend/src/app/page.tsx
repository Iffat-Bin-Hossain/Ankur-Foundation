...
import { Heart, Leaf, Users, Award, Camera, DollarSign, FileText, Mail, Phone, MapPin, Facebook, Linkedin, Twitter, ExternalLink } from 'lucide-react'
      ...
      <nav className="bg-white shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 max-w-6xl flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 bg-gradient-to-br from-green-400 to-green-700 rounded-full flex items-center justify-center">
              <Leaf className="w-6 h-6 text-white" />
            </div>
            <span className="text-2xl font-bold text-green-700">Ankur</span>
          </div>
      ...
      <div className="bg-gradient-to-br from-green-50 to-blue-50 py-20">
        <div className="container mx-auto px-4 max-w-6xl text-center">
          <div className="mb-8 flex justify-center">
            <div className="w-32 h-32 bg-gradient-to-br from-green-400 to-green-700 rounded-full shadow-lg flex items-center justify-center">
